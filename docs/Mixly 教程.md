...
从指定的模拟管脚读取旋转电位器的模拟信号，模拟信号的范围为：0 ~ 4096 。
...
将旋转电位器的模拟信号（0 ~ 4096）映射给LED的亮度（0 ~ 255）。
...
从指定的模拟管脚读取火焰传感器的模拟信号，模拟信号的范围为：0 ~ 4096 。
...
从指定的模拟管脚读取光敏电阻的模拟信号（光照强度），模拟信号的范围为：0 ~ 4096 。
...
6. 先从 “![Img](./media/img-20241023140218.png)” 拖出 “![Img](./media/img-20241029151254.png)” ，从 “ ![Img](./media/img-20241029153615.png) ” 拖出 “ ![Img](./media/img-20241029154054.png) ”，管脚为 14 。
...
（3）点击![图片不存在](./Arduino/media/1c7de5dcf1bc26c05aa6776876007fb7.png)按钮，电机（带小风扇叶）转动；再次点击![图片不存在](./Arduino/media/1c7de5dcf1bc26c05aa6776876007fb7.png)按钮，关闭电机。

（4）在超声波传感器前放一个物体，点击![图片不存在](./Arduino/media/333c0081491bda5b140b2ed1e365e015.png)按钮，超声波传感器测距，串口监视器窗口显示距离值，说明此时物体离超声波传感器的距离为301.2cm；再次点击![图片不存在](./Arduino/media/333c0081491bda5b140b2ed1e365e015.png)按钮，关闭超声波。

（5）点击![图片不存在](./Arduino/media/ba27f5c4eb27223a8293f112037fd219.png)按钮，温湿度传感器测量环境中的温度，串口监视器窗口显示温度值，说明此时环境中的温度为28.6℃；再次点击![图片不存在](./Arduino/media/ba27f5c4eb27223a8293f112037fd219.png)按钮，关闭温湿度传感器。

（6）点击![图片不存在](./Arduino/media/100e3e7685ce761e53f5b80d76d80c73.png)按钮，温湿度传感器测量环境中的湿度，串口监视器窗口显示湿度值，说明此时环境中的湿度为54.4%；再次点击![图片不存在](./Arduino/media/100e3e7685ce761e53f5b80d76d80c73.png)按钮，关闭温湿度传感器。
