...
打开Arduino IDE，单击“**项目**”→“**包含库**”→“**添加.ZIP库...**”。在弹出窗口中找到该目录下名为**Keyes ESP32 高级版学习套件\4. Arduino C 教程\1. Windows 系统\2. Arduino 库文件\MFRC522_I2C.ZIP**的文件，先选中**MFRC522_I2C.ZIP**文件，再单击“**打开**”。
![Img](../../../media/添加MFRC522_I2C和Wire库1img-20230418175011.jpg)
![Img](../../../media/添加MFRC522_I2C和Wire库2img-20230418175116.png)
接着在弹出窗口中找到该目录下名为**Keyes ESP32 高级版学习套件\4. Arduino C 教程\1. Windows 系统\2. Arduino 库文件\Wire.ZIP**的文件，先选中**Wire.ZIP**文件，再单击“**打开**”
![Img](../../../media/添加MFRC522_I2C和Wire库3img-20230418175258.png)

“<span style="color: rgb(255, 76, 65);">MFRC522_I2C</span>”和“<span style="color: rgb(255, 76, 65);">Wire</span>”库都添加完后，你可以打开我们提供的代码：

本项目中使用的代码保存在（即路径)：**..\Keyes ESP32 高级版学习套件\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目32 RFID\Project_32.1_RFID_Read_UID** 。
...
![Img](../../../media/白卡和钥匙扣的卡号值img-20230418175843.png)
...
![Img](../../../media/添加MFRC522_I2C，Wire和ESP32Servo库1img-20230419081526.png)
...
## 7.项目代码：
<span style="color: rgb(255, 76, 65);">MFRC522_I2C</span>，<span style="color: rgb(255, 76, 65);">Wire</span>和<span style="color: rgb(255, 76, 65);">ESP32Servo</span>库添加完成后，你可以打开我们提供的代码：
<br>
<br>

本项目中使用的代码保存在（即路径)：**..\Keyes ESP32 高级版学习套件\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目32 RFID\Project_32.2_RFID_Control_Servo** 。
...
<br>
<br>
<span style="color: rgb(255, 76, 65);">例如: 你把程序代码![Img](../../../media/程序代码中rfid_str字符串img-20230419083049.png)中的rfid_str字符串替换成自己的RFID-RC522模块读取的白卡和钥匙扣值。</span>
<br>
<br>
...
![Img](../../../media/模拟开门img-20230419083936.png)
