...
本项目中使用的代码保存在（即路径)：**..\Keyes ESP32 高级版学习套件\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目36 WiFi 工作模式\Project_36.1_WiFi_Station_Mode** 。
...
![Img](../../../media/项目36-1img-20230419133250.png)
...
![Img](../../../media/项目36-2img-20230419134248.png)
...
本项目中使用的代码保存在（即路径)：**..\Keyes ESP32 高级版学习套件\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目36 WiFi 工作模式\Project_36.2_WiFi_AP_Mode** 。
...
![Img](../../../media/项目36-3img-20230419134941.png)
...
![Img](../../../media/项目36-4img-20230419135401.png)
...
本项目中使用的代码保存在（即路径)：**..\Keyes ESP32 高级版学习套件\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目36 WiFi 工作模式\Project_36.3_WiFi_Station_AP_Mode** 。
...
![Img](../../../media/项目36-5img-20230419140054.png)

## 4.项目现象：
确认程序代码修改正确后，编译并上传代码到 ESP32主板上，上传成功后，打开串口监视器，设置波特率为<span style="color: rgb(255, 76, 65);">115200</span>。然后串口监视器窗口将显示如下：(如果打开串口监视器且设置波特率为115200之后，串口监视器窗口没有显示如下信息，可以按下ESP32的复位键![Img](../../../media/按下ESP32的复位键img-20230419105000.jpg)）
![Img](../../../media/项目36-6img-20230419140649.png)
