...
本项目中使用的代码保存在（即路径)：**..\Keyes ESP32 高级版学习套件\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目28 摇杆控制RGB灯\Project_28.1_Read_Rocker_Value** 。
...
![Img](../../../media/项目28-5img-20230418161214.png)
...
本项目中使用的代码保存在（即路径)：**..\Keyes ESP32 高级版学习套件\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目28 摇杆控制RGB灯\Project_28.2_Rocker_Control_Light** 。
