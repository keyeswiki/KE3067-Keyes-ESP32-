...
4 . 选择安装选项为“Anyone who uses this computer(all users)”后再点击Next。
...
8 . 安装完成后，会在桌面上生成一个Arduino IDE软件快捷方式，单击 “Finish” 并运行Arduino IDE。

![图片不存在](./media/9152131aa663c6c5723a96c9e6f7a9a1.png)

### **3. Arduino IDE工具栏介绍**

点击电脑桌面上的图标![图片不存在](./media/edbce928e27d6f6d26e0a6df960421da.png)，打开Arduino IDE。
...
(1)点击电脑桌面上的图标![图片不存在](./media/edbce928e27d6f6d26e0a6df960421da.png)，打开Arduino IDE。
...
（6）先点击“**工具**”→“**开发版:**”，再点击“**开发版管理器...**”进入“**开发版管理器**”页面，在文本框中输入“**esp32**”，选择 <span style="color: rgb(255, 76, 65);">1.0.6</span> 版本进行安装，安装包不大，点击“**安装**”开始安装相关安装包。如下图：**<span style="color: rgb(255, 76, 0);">（特别提醒：如果选择更高版本或最新版本，在后续课程上传代码中可能报错。）</span>**
...
![图片不存在](./media/3246c24f086499d7a4acf7aed84e44b7.png)

（1）打开Arduino IDE![图片不存在](./media/edbce928e27d6f6d26e0a6df960421da.png)，在Arduino IDE界面点击“**项目**”→“**包含库**”→“**添加.ZIP库...**”。
...
![图片不存在](./media/4cfe33d7feaf2a225dbb4b8ff87af6ee.png)
...
单击![图片不存在](./media/上传img-20230418112107.png)将项目代码上传到ESP32主板上。
...
![图片不存在](./media/dd983623a3bd853f4d8d567d8c0d0e63.png)

单击![图片不存在](./media/86b9e2ff982873d7304e9ba692e7f0da.png)将项目代码上传到ESP32主板上。

![图片不存在](./media/7293f3ff10f053da942b3d72c31a6517.png)
...
![图片不存在](./media/4c4de10253147bcb786652053647f5f3.png)
...
![图片不存在](./media/dea80008b893d0c145ebcb837a02a305.png)

![图片不存在](./media/8815c6bb04a4757d74eedadb0a23ebb2.png)
...
![图片不存在](./media/148b24945f997203329eeb6512ad8758.png)
...
![图片不存在](./media/14bc1abcf48ed5a4edc335b8ee8c4c6a.png)

![图片不存在](./media/0d4c5348b121368fe673afa062b9fb50.png)
...
![图片不存在](./media/0a8f5aa82bea27a65f8455e9a180de96.png)

![图片不存在](./media/d06be8e0f725c4d370cd7f10ae33e60c.png)
...
![图片不存在](./media/e210dbc7997c08500968c937965153ad.png)
...
![图片不存在](./media/a5d14642c10b5b4b1bdbf638dad41d75.png)
...
![图片不存在](./media/4e7b119bfb73a29a88cd9e185399d0de.png)
...
![图片不存在](./media/c5f0c64b5c7ca20dd54a48e167bf835b.png)
...
![图片不存在](./media/6ff835d2528335b7f00acfb5a196b66d.jpg)

![图片不存在](./media/241b68d2061444007abfe104eab9fefd.png)
...
![图片不存在](./media/c6e06e29f0189b2d9fd4c15e9566be57.png)
...
![图片不存在](./media/40e02685a4526777cb2c436cb5434af5.jpg)
...
![图片不存在](./media/84d1aca9aa7ce5664e12d0dca12fc9db.jpg)

![图片不存在](./media/45ce89cdac321946b7dc008fc343b3b8.png)

接着在弹出窗口中找到该目录下名为 **..\库文件\Arduino_C_Windows系统\Wire.ZIP**的文件，先选中**Wire.ZIP**文件，再单击“ **打开** ”

![图片不存在](./media/9449ab10285a49a3696e3bc88e51e177.png)
...
![图片不存在](./media/62b7783929a342734e4a0fed04096756.png)
...
![图片不存在](./media/611afdeb9c90d70563d9c1b1d2859566.png)
...
<br>
<span style="color: rgb(255, 76, 65);">例如: 你把程序代码</span>![图片不存在](./media/a091416908ab6203263ba3063da6f35d.png)<span style="color: rgb(255, 76, 65);">中的rfid_str字符串替换成自己的RFID-RC522模块读取的白色磁卡和钥匙扣的值。</span>
<br>
```
//*************************************************************************************
/* 
...
![图片不存在](./media/6109585b8094a039f38dde0e4237228c.png)
...
![图片不存在](./media/6bc5433f35f028715e34f685cdce5ab6.png)

![图片不存在](./media/18d5f282716b9980358c1ae3a314a598.png)
...
![图片不存在](./media/3ce31d5c11af95e4ba2c7f06299c0852.png)
...
![图片不存在](./media/91addaa8de14e156b14acad522ea8165.png)

![图片不存在](./media/cd8887afe8b89477808c3c2c7ef5f9e8.png)
...
![图片不存在](./media/a1ca9b3c61b83d5fa18e8db042189d0d.png)
...
![图片不存在](./media/37cb879b7c5485ba2544d27d6407e4bb.png)
```
//**********************************************************************************
/*
 * 文件名 : 经典的蓝牙
...
![图片不存在](./media/a806cadfcb5ec63f4d1525302bb02332.png)
...
![图片不存在](./media/1da0eccd7be73449280674508c7fba72.png)
...
![图片不存在](./media/538e56d1f4cded360c56f6db9852f7f3.png)
...
![图片不存在](./media/d0d763f915a23c72e97611126d19e548.png)
...
![图片不存在](./media/fada6409bd5fde4ace40c74e3404d414.png)
...
![图片不存在](./media/b4a7b34e7438d88c83001aefda84a7f2.png)

**4.项目现象：**

确认程序代码修改正确后，编译并上传代码到 ESP32主板上，上传成功后，打开串口监视器，设置波特率为<span style="color: rgb(255, 76, 65);">115200</span>。然后串口监视器窗口将显示如下：(如果打开串口监视器且设置波特率为115200之后，串口监视器窗口没有显示如下信息，可以按下ESP32的复位键![图片不存在](./media/515a31c10d414cae43980905e7df1879.jpg)）

![图片不存在](./media/0a0b4e200d48018ee19edcde6b27ec9c.png)
...
|![图片不存在](./media/afc52f6616725ba37e3b12a2e01685ad.png)|![图片不存在](./media/a2aa343488c11843f13ae0413547c673.png)|![图片不存在](./media/2d879e56de94fbb14399ec17c0b10861.png)|![图片不存在](./media/c910a7be7acddac1d2c4e4a1613524f4.png)|
| :--: | :--: | :--: | :--: |
...
|![图片不存在](./media/4d0be04892e2038c372f82caba521f64.png)|![图片不存在](./media/c562656c96657983e724daed7c8d6202.png)|![图片不存在](./media/3cc5c242c0f357b3dc496037a7d8bae8.png)|![图片不存在](./media/ed228ff5627e0c8cc0c79fa04f1d4d16.png)|
|智能手机/平板电脑(<span style="color: rgb(255, 76, 65);">自备</span>)*1|面包板专用电源模块*1|6节5号电池盒*1|风扇叶*1|
|![图片不存在](./media/4c49cdffc9e5e6f1aad838120d35897a.png)|![图片不存在](./media/b4421594adeb4676d63581a1047c6935.png)| ![图片不存在](./media/1a190cfbfe81a1524e1d1ef681688a64.png)|![图片不存在](./media/e989c0ba5c3c1ea8c5fc08d02344da37.png)|
...
![图片不存在](./media/344eb73d8060a421457efecce1ec0f4e.png)
...
![图片不存在](./media/58222111b35fa4250914e49aa3e20826.png)
...
![图片不存在](./media/0fda40d84316e4b01ffbc71f0061ae61.png)
